      ...
      <section className="pt-14 pb-24 md:pt-20 md:pb-32 relative overflow-hidden bg-[color:var(--background)] dark:bg-[color:var(--card)]/10">
        ...
        <div className="container-custom">
          <div className="max-w-4xl">
            ...
            >
              Predictive AI for <span className="bg-gradient-to-r from-primary to-secondary text-gradient">Supply Chain & Fleet Optimization</span>
            </motion.h1>
      ...
      <section id="solutions" className="py-20 bg-[color:var(--background)] dark:bg-[color:var(--card)]/10">
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-[color:var(--foreground)] mb-4">Our Logistics Solutions</h2>
            <p className="text-[color:var(--muted-foreground)] max-w-3xl mx-auto">AI-powered systems designed specifically for the challenges facing modern logistics operations.</p>
          </div>
